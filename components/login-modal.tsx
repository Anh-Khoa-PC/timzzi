    ...
    <>
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-[380px] bg-white rounded-lg shadow-xl">
        ...
        <div className="p-8">
          ...
          <h2 className="text-2xl font-bold text-center mb-2">Sign in to timzzi</h2>
          ...
          <form className="space-y-3">
            <div>
              <label htmlFor="email" className="text-xs font-medium text-[#0073bb] mb-1 block">
                Email
              </label>
              <Input
                id="email"
                type="email"
                className="h-12 border-gray-300 focus:border-[#0073bb] focus:ring-[#0073bb]"
              />
            </div>
            ...
            <div>
              ...
              <Input id="password" type="password" placeholder="Password" className="h-12 border-gray-300" />
            </div>

            <Button type="submit" className="w-full h-12 bg-[#d32323] hover:bg-[#b91e1e] text-white font-semibold">
              Log in
            </Button>
          </form>
          ...
          <div className="text-center mt-4">
            <a href="#" className="text-sm text-[#0073bb] hover:underline">
              Login via email link
            </a>
          </div>
          ...
          <div className="text-center mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-700">
              New to timzzi?{" "}
              <button onClick={onSwitchToSignup} className="text-[#0073bb] font-semibold hover:underline">
                Sign up
              </button>
            </p>
          </div>
